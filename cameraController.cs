...
public class cameraController : MonoBehaviour
{
    ...
    private void calculateScreen(Transform fighter1pos, Transform fighter2pos)
    {
        ...
        {
            xLeft = fighter1pos.position.x ;
            xRight = fighter2pos.position.x;
        }
        else
        {
            xRight = fighter1.position.x ;
            xLeft = fighter2pos.position.x;
        }
    }
    ...
    void Start()
    {
        ...
        fighter1 = GameObject.Find("Player1").transform;
        fighter2 = GameObject.Find("Player2").transform;
